...
CREATE TABLE CONTAINERS_INIT_LOCATION(
  ...
  CONSTRAINT FOREIGN KEY (SCENARIO) REFERENCES SCENARIO(ID) ON DELETE CASCADE,
  CONSTRAINT FOREIGN KEY (CONTAINER_NAME) REFERENCES CONTAINER(NAME) ON DELETE CASCADE, -- todo : see if there is a way to reach scenario.terminal property
...
CREATE TABLE STRADDLECARRIERS_LOCATION(
  ...
  SIMULATION smallint(6) unsigned not null REFERENCES SIMULATION(ID) ON DELETE CASCADE,
  T TIME(10) not null,
  ROAD VARCHAR(30) not null REFERENCES ROADS(NAME) ON DELETE CASCADE,
...
CREATE TABLE MISSION_LOAD (
	...
	MISSION VARCHAR(30) not null REFERENCES MISSION(NAME) ON DELETE CASCADE,
	...
	CONSTRAINT FOREIGN KEY (MISSION) REFERENCES MISSION(NAME) ON DELETE CASCADE,
...
INSERT INTO DEFAULT_SCHEDULING_PARAMETERS (PARAM_NAME, VALUE) VALUES ('L','1.0');
INSERT INTO DEFAULT_SCHEDULING_PARAMETERS (PARAM_NAME, VALUE) VALUES ('T','1.0');
INSERT INTO DEFAULT_SCHEDULING_PARAMETERS (PARAM_NAME, VALUE) VALUES ('E','1.0');
