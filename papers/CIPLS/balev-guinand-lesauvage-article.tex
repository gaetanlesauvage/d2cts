...
\begin{figure}[ht]
  \begin{center}
  \includegraphics[width=0.6\textwidth]{terminalOfNormandy.tiff}
...
\begin{center}
  ...
  \end{center}
\begin{center}
  \begin{tikzpicture}[-,thick,xscale=0.2,yscale=0.4]
...
\newblock {\em European Journal of Operational Research}, 187(3):985--1032,
  June 2008.

\bibitem{Lesauvage2009}
Stefan Balev, Fr{\'e}d{\'e}ric Guinand, Ga{\"e}tan Lesauvage, and D.~Olivier.
\newblock {Dynamical Handling of Straddle Carriers Activities on a Container
  Terminal in Uncertain Environment - A Swarm Intelligence approach -}.
...
\newblock {\em European Journal of Operational Research}, 202(1):8 -- 15, 2010.

\bibitem{Bertelle2006}
...
\newblock {\em International Transactions on Systems Science and Applications},
  2(1):61--70, 2006.

\bibitem{Bertelle2007}
Cyrille Bertelle, Antoine Dutot, Frédéric Guinand, and Damien Olivier.
\newblock Organization detection for dynamic load balancing in individual-based
  simulations.
\newblock {\em Multi-Agent and Grid Systems}, 3(1):42, 2007.
...
\newblock The job shop scheduling problem: Conventional and new solution
  techniques.
\newblock {\em European Journal of Operational Research}, 93(1):1--33, August
  1996.

\bibitem{Brucker1990}
P.~Brucker and R.~Schlie.
\newblock Job-shop scheduling with multi-purpose machines.
\newblock {\em Computing}, 45:369--375, 1990.
\newblock 10.1007/BF02238804.

\bibitem{Brucker2010}
Peter Brucker.
\newblock {\em Scheduling Algorithms}.
...
\newblock {\em The 17th International Workshop on}, pages 126--131, 1997.

\bibitem{Mitrovic1998}
S~Mitrovic-Minic.
\newblock Pickup and delivery problem with time windows: A survey.
\newblock {\em SFU CMPT TR}, 12(1):1–43, 1998.

\bibitem{Mitrovic2001}
S.~Mitrovic-Minic.
\newblock {\em The dynamic pickup and delivery problem with time windows}.
\newblock Simon Fraser University, 2001.

\bibitem{Mitrovic2006}
Snežana Mitrović-Minić and Ramesh Krishnamurti.
\newblock The multiple tsp with time windows: vehicle bounds based on
  precedence graphs.
\newblock {\em Operations Research Letters}, 34(1):111 -- 120, 2006.

\bibitem{Montemanni2005}
R.~Montemanni, L.~Gambardella, A.~Rizzoli, and A.~Donati.
\newblock Ant colony system for a dynamic vehicle routing problem.
\newblock {\em Journal of Combinatorial Optimization}, 10:327--343, 2005.
\newblock 10.1007/s10878-005-4922-6.

\bibitem{Ouelhadj2009}
Djamila Ouelhadj and Sanja Petrovic.
\newblock {A survey of dynamic scheduling in manufacturing systems}.
\newblock {\em J. of Scheduling}, 12(4):417--431, August 2009.

\bibitem{Ponnambalam2005}
S~G Ponnambalam, N~Jawahar, and B~S Girish.
\newblock An ant colony optimization algorithm for flexible job shop scheduling
  problem.
\newblock {\em Advanced Science Letters}, 4(Pinedo):2127--2131, 2005.
...
\newblock {\em The International Journal of Advanced Manufacturing Technology},
  16:609--615, 2000.
\newblock 10.1007/s001700070052.

\bibitem{Ramasesh1990}
R.~Ramasesh.
\newblock Dynamic job shop scheduling: A survey of simulation research.
\newblock {\em Omega}, 18(1):43 -- 57, 1990.

\bibitem{Suresh1993}
V.~Suresh and Dipak Chaudhuri.
\newblock Dynamic scheduling—a survey of research.
\newblock {\em International Journal of Production Economics}, 32(1):53 -- 63,
  1993.

\bibitem{Taillard1994}
{\'E}ric~D. Taillard.
\newblock Parallel taboo search techniques for the job shop scheduling problem.
\newblock {\em INFORMS Journal on Computing}, 6(2):108--117, 1994.
...
\bibitem{Apinanthana2011}
Apinanthana Udomsakdigool and Voratas Kachitvichyanukul.
\newblock {Ant colony algorithm for multi-criteria job shop scheduling to
  minimize makespan, mean flow time and mean tardiness}.
\newblock {\em International Journal of Management Science and Engineering
  Management}, 6(2):117--123, 2011.
...
\newblock {A Dynamic Model of Tabu Search for the Job-Shop Scheduling Problem}.
\newblock {\em Proc. of the 1st Multidisciplinary Int. Conf. on Scheduling:
  Theory and Applications}, pages 320--336.

\bibitem{Gere1966}
Jr. William S.~Gere.
\newblock Heuristics in job shop scheduling.
\newblock {\em Management Science}, 13(3):167--190, November 1966.
...
\newblock A knowledge-based ant colony optimization for flexible job shop
  scheduling problems.
\newblock {\em Applied Soft Computing}, 10(3):888 -- 896, 2010.
...
\newblock Applying ant colony optimization (aco) algorithm to dynamic job shop
  scheduling problems.
\newblock {\em International Journal of Manufacturing Research}, 3(3):301--320,
  2008.
