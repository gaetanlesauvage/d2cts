...
\begin{columns}
    ...
    \begin{column}[r]{4.5cm}
		\begin{flushright}
		  \includegraphics[height=.37\textheight]{../Articles/Figures/angles.jpg}
		\end{flushright}
    \end{column}
 \end{columns}	
 	...
 	\begin{columns}
		...
		\end{column}
 	 	\begin{column}[r]{7.5cm}
			\begin{flushright}
				\includegraphics[height=.55\textheight]{../Articles/Figures/terminalDeNormandie.jpg}
			\end{flushright}
		\end{column}
 	\end{columns}
\begin{itemize}
...
\begin{columns}
  ...
  \begin{column}[r]{3cm}
	\begin{flushright}
	    \includegraphics[height=.5\textheight]{../Articles/Figures/Containerlift_straddle_carrier.jpg}
	\end{flushright}
  \end{column}
\end{columns}	
\end{frame}
...
\end{column}
  \begin{column}[r]{5.5cm}
	\begin{flushright}
	    \includegraphics[height=.5\textheight]{../Articles/Figures/threeKindsOfMissions.png}
	\end{flushright}
  \end{column}
\end{columns}
\end{frame}
...
\frametitle{Solution}
	...
	\begin{center}
		\includegraphics[height=.40\textheight]{../Articles/Figures/missionGraphWith2NodesRemoved.png}
	\end{center}
\end{frame}
...
\frametitle{2 vues parallèles du système}
	\setbeamertemplate{blocks}[rounded][shadow=true]
 	\begin{columns}
		...
		\end{column}
 	\end{columns}
	\begin{center} \includegraphics[height=3.7cm]{../Articles/Figures/terminalEtGraphe.png} \end{center}
