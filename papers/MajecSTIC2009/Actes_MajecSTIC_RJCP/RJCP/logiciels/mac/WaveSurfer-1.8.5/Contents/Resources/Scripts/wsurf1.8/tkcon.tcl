...
# hack for WaveSurfer's mkPkgIndex.tcl
package provide tkcon 2.4
...
proc ::tkcon::Init {args} {
	...
	RCS		{RCS: @(#) $Id: tkcon.tcl,v 1.3 2005/09/26 10:38:16 beskow Exp $}
    ...
    Prompt "$title console display active (Tcl$::tcl_patchLevel / Tk$::tk_patchLevel / Snack$::snack::patchLevel)\n"
}
