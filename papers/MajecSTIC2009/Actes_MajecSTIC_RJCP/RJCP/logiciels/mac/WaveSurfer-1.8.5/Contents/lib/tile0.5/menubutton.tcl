#
# $Id: menubutton.tcl,v 1.5 2004/08/25 23:58:11 hobbs Exp $
#
...
#
proc tile::menubutton::PostPosition {mb menu} {
...
#
proc tile::menubutton::Popdown {mb} {
...
#
proc tile::menubutton::Pulldown {mb} {
    variable State
    if {[$mb instate disabled] || [set menu [$mb cget -menu]] eq ""} {
	return
    }
...
#
proc tile::menubutton::TransferGrab {mb} {
    variable State
    if {$State(pulldown)} {
...
#	-1 if not found.
#
proc tile::menubutton::FindMenuEntry {menu s} {
