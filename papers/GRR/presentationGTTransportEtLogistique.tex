...
\defbeamertemplate*{footline}{infolines theme}
{
	...
	\hbox{%
		...
		\begin{beamercolorbox}[wd=.33\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
			\usebeamerfont{date in head/foot}november 6th, 2009\hspace*{2em}
...
\title[3e Journée du GT Transport et Logistique]
{
...
\institute[UFR ST Le Havre]
{
	\begin{columns}
		\begin{column}[l]{6cm}
			...
			\textit{Unit\'{e} de Formation et de Recherche des Sciences et Techniques}
			\end{center}
		\end{column}
		\begin{column}[r]{6cm}
			\begin{center}
			\includegraphics[height=.1\textheight]{fig/logolitis.png} \\
			\textit{Laboratoire d'Informatique et du Traitement de l'Information et des Syst\`{e}mes}
			\end{center}
		\end{column}
	\end{columns}
...
\subject{GT Transport et Logistique}
\begin{document}
...
\frametitle{Uncertain Environnement}
	There are several unpredictable events such as :
	  ...
	  \item Human behavior %bien insister là-dessus et dire que seuls les conducteurs ont le pouvoir de respecter le plan d'ordonnancement
	\end{itemize}
\end{frame}
...
\bibliography{biblioGTTransportEtLogistique}
% \begin{frame}
