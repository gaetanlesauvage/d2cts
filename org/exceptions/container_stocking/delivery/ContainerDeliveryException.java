...
public abstract class ContainerDeliveryException extends Exception implements Serializable {
	/**
	 * 
	 */
	...
	protected ContainerDeliveryException(ContainerLocation location, String message){
		super(message);
