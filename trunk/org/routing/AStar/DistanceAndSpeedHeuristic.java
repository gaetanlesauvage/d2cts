...
public class DistanceAndSpeedHeuristic implements AStarHeuristic {
	public static final String NAME = "DistanceAndSpeedHeuristic";
	private SpeedCharacteristics speed;

	public DistanceAndSpeedHeuristic(SpeedCharacteristics speed) {
		this.speed = speed;
	}
	...
	public double heuristic(RoadPoint from, RoadPoint to) {
		return Location.getLength(from.getLocation(), to.getLocation());
	}
