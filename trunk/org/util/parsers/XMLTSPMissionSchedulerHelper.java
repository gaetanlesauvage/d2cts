...
/**
 * Helper used to set the TSP ACO mission scheduler parameters
 * @author Ga&euml;tan Lesauvage
 * @since 2012
 */

public class XMLTSPMissionSchedulerHelper extends XMLMissionSchedulerHelper {
	 ...
	 */
	public XMLTSPMissionSchedulerHelper(OfflineSchedulerParameters parameters, MissionSchedulerEvalParameters evalParameters){
	 ...
	 */
	public OfflineSchedulerParameters getParameters(){
		return parameters;
	}
}