...
public class GreedyParametersDAO
		extends
		AbstractSchedulingParameterDAO<GreedyMissionScheduler, GreedyParametersBean> {
	...
	public void load() throws SQLException {
		...
		while (rs.next()) {
			GreedyParametersBean parameter = GreedyParametersBean
